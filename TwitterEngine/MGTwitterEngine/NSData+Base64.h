 ...
 *      @discussion	This method returns an autoreleased NSData object. The NSData object is
 * initialized with the
 *                              contents of the Base 64 encoded string. This is a convenience
 * method.
 ...
 *      @discussion	The NSData object is initialized with the contents of the Base 64 encoded
 * string.
 ...
 *      @discussion	This method returns a Base 64 encoded string representation of the data
 * object.
 *      @param	inLineLength A value of zero means no line breaks.  This is crunched to a multiple
 * of 4 (the next
