...
typedef enum _MGTwitterRequestType {
	...
	MGTwitterFollowedTimelineRequest, /* latest statuses from the people that the current users
	                                   * follows */
	...
	MGTwitterUpdateDeleteRequest, /* delete an update for the current user using the specified
	                               * id */
	...
	MGTwitterFriendUpdatesForUserRequest, /* last status for the people that the specified user
	                                       * follows */
	...
	MGTwitterAccountLocationRequest, /* change location in account information for the current
	                                  * user */
	MGTwitterAccountDeliveryRequest, /* change notification delivery in account information for
	                                  * the current user */
	...
	MGTwitterFavoritesEnableRequest, /* create a favorite for the current user using the
	                                  * specified id */
	MGTwitterFavoritesDisableRequest, /* remove a favorite for the current user using the
	                                   * specified id */
