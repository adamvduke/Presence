...
- (BOOL)clearsCookies; /* YES = deletes twitter.com cookies when setting username/password, default
                        * is NO (see README.txt) */
...
- (NSString *)getFollowedTimelineSinceID:(unsigned long)sinceID withMaximumID:(unsigned long)maxID startingAtPage:(int)pageNum count:(int)count; /*
                                                                                                                                                  * statuses/friends_timeline */

- (NSString *)getUserTimelineFor:(NSString *)username sinceID:(unsigned long)sinceID startingAtPage:(int)pageNum count:(int)count; /*
                                                                                                                                    * statuses/user_timeline
                                                                                                                                    * &
                                                                                                                                    * statuses/user_timeline/user */
- (NSString *)getUserTimelineFor:(NSString *)username sinceID:(unsigned long)sinceID withMaximumID:(unsigned long)maxID startingAtPage:(int)pageNum count:(int)count; /*
                                                                                                                                                                       * statuses/user_timeline
                                                                                                                                                                       * &
                                                                                                                                                                       * statuses/user_timeline/user */
...
- (NSString *)getRepliesSinceID:(unsigned long)sinceID startingAtPage:(int)pageNum count:(int)count; /*
                                                                                                      * statuses/mentions */
- (NSString *)getRepliesSinceID:(unsigned long)sinceID withMaximumID:(unsigned long)maxID startingAtPage:(int)pageNum count:(int)count; /*
                                                                                                                                         * statuses/mentions */
...
- (NSString *)getDirectMessagesSinceID:(unsigned long)sinceID startingAtPage:(int)pageNum; /*
                                                                                            * direct_messages */
- (NSString *)getDirectMessagesSinceID:(unsigned long)sinceID withMaximumID:(unsigned long)maxID startingAtPage:(int)pageNum count:(int)count; /*
                                                                                                                                                * direct_messages */

- (NSString *)getSentDirectMessagesSinceID:(unsigned long)sinceID startingAtPage:(int)pageNum; /*
                                                                                                * direct_messages/sent */
- (NSString *)getSentDirectMessagesSinceID:(unsigned long)sinceID withMaximumID:(unsigned long)maxID startingAtPage:(int)pageNum count:(int)count; /*
                                                                                                                                                    * direct_messages/sent */
...
- (NSString *)getFollowedIdsForUsername:(NSString *)username; /* friends/ids */
...
- (NSString *)setLocation:(NSString *)location; /* account/update_location (deprecated, use
                                                 * account/update_profile instead) */
...
/* - (NSString *)getUserUpdatesArchiveStartingAtPage:(int)pageNum; // account/archive (removed, use
 * /statuses/user_timeline instead) */

/* Favorite methods */

- (NSString *)getFavoriteUpdatesFor:(NSString *)username startingAtPage:(int)pageNum; /* favorites */

- (NSString *)markUpdate:(unsigned long)updateID asFavorite:(BOOL)flag; /* favorites/create,
                                                                         * favorites/destroy */
...
- (NSString *)getSearchResultsForQuery:(NSString *)query sinceID:(unsigned long)sinceID startingAtPage:(int)pageNum count:(int)count; /*
                                                                                                                                       * search */
